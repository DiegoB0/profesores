...
const TutoIndividualesPage = () => {
	...
	function renderMain() {
		if (tutoriasIndividuales.length === 0)
			return (
		...
		return tutoriasIndividuales.map((tutoria) => (
				...
				<div className="pb-4  bg-white rounded-lg">
					...
					<div className="absolute inset-y-0 right-0">
						<button
							...
							onClick={() => navigate('/tutorias/individuales/new')}
						>
...
export default TutoIndividualesPage;
